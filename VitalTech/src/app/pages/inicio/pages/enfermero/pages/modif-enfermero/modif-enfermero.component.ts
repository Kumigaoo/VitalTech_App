...
export class ModifEnfermeroComponent {
  ...
  constructor(private fb: FormBuilder, private http: HttpClient, private personalService: EnfermeroService, private router: Router, private route: ActivatedRoute) {
  ...
  onUpdate() {
    if (this.modiPersonalForm.valid) {
      const updatePersonal: Enfermer = { ...this.modiPersonalForm.getRawValue() };
