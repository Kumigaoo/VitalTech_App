  ...
  citas.forEach((cita) => {
    rows.push(
      <CitaRow
        ...
        key={cita.motivo}
        onSelect={onSelect}
        isSelected={selectedCita === cita}
      />
    );
  });
  return <div className="agenda-list">{rows}</div>;
}
  ...
  return (
    <>
      ...
      <div className="agenda-container">
        <ListaCitas
          citas={citas}
          onSelect={(cita) => setSelectedCita(cita)}
          selectedCita={selectedCita}
        />
        {selectedCita && (
          <Box
            className="cita-info-box"
            sx={{
              marginLeft: 2,
              padding: 2,
          ...
          >
            ...
            <Typography variant="body1">
              <strong>Planta:</strong> {selectedCita.planta}
            </Typography>
            <Typography variant="body1">
              <strong>Piso:</strong> {selectedCita.piso}
            </Typography>
            <button className="agenda-button-cell" onClick={handleCancelCita}>
              Cancelar cita
            </button>
            <Typography
              variant="body1"
