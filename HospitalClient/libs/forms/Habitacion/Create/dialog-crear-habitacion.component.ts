...
@Component({
  ...
  templateUrl: '../../../../apps/GoldenFold/src/app/components/Formularios/Habitacion/dialog-crear-habitacion/dialog-crear-habitacion/dialog-crear-habitacion.component.html',
  styleUrl: '../../../../apps/GoldenFold/src/app/components/Formularios/Habitacion/dialog-crear-habitacion/dialog-crear-habitacion/dialog-crear-habitacion.component.css',
  imports: [
    ReactiveFormsModule,
...
export class DialogCrearHabitacionComponent {
  ...
  ngOnInit(): void {
    ...
    this.habForm
      .get('plantaId')
      ?.valueChanges.subscribe(() => this.obtenerPlantas());
  ...
  constructor(
    private dialog: MatDialogRef<DialogCrearHabitacionComponent>,
