...
export class SolicitudesIngresoComponent implements OnInit {
  ...
  constructor(private ingresoService: IngresoService, private historialAltaService: HistorialAltaService, private camaService: CamaService, private asignacionService: AsignacionService) { }
  ...
  obtenerSolicitudesPendientes() {
    this.ingresoService.getIngresos(undefined, undefined, 'Pendiente').subscribe({
  ...
  obtenerCamasDisponibles(tipoCama: string) {
    ...
    this.asignacionService.getAsignaciones(undefined, undefined, new Date(), null, undefined).subscribe({
      next: (asignaciones) => {
