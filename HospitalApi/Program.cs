...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowSpecificOrigin",
        policy =>
        {
            policy.WithOrigins("https://localhost:4201", "http://localhost:3000","https://localhost:3000", "https://localhost:7200", "https://localhost:4200", "https://127.0.0.1:4200", "https://127.0.0.2:4201")
                  .AllowAnyHeader()
                  .AllowAnyMethod();
        });
});
...
{
    options.IdleTimeout = TimeSpan.FromMinutes(10000000);
