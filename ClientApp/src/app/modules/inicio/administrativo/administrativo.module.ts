...
@NgModule({
  ...
  declarations: 
    [AdministrativoComponent, RegistrarPacienteComponent, BuscarPacientesComponent, PacientesAdministrativoComponent],
  imports: 
    [ AdministrativoRout, AdministrativoDashboardComponent, SharedModule]
