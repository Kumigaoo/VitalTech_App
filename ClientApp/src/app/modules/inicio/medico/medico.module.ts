...
@NgModule({
  declarations: 
  [ MedicoComponent, BuscarPacienteComponent, ConsultasProgramadasComponent, IngresosAdministrativoComponent],
  imports: 
  [ MedicoRoute, MedicoDashboardComponent, SharedModule ]
})
