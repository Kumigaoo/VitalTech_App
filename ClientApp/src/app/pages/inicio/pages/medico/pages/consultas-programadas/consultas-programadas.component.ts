...
export class ConsultasProgramadasComponent {
  ...
  constructor(private consultaService: ConsultaService, private ingresoService: IngresoService, private historialAltaService: HistorialAltaService) { }
  ...
  obtenerConsultasPendientes() {
    ...
    this.consultaService.getConsultas(undefined, IdMedico, 'pendiente').subscribe({
